            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="resources/file/콕.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                                       ...
                                       <div class="latest-prdouct__slider__item">
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="resources/file/${list3.BFileName}" alt="">
                                            </div>
                             ...
                             <c:forEach var="list2" items="${boardList2}">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="resources/file/${list2.BFileName}" width=100 height=70>
                                    </div>
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-6"> 
                 		  <div class="blog__item">
                				<div class="blog__item__pic">
                                    ...
                                    <img src="resources/file/${list.BFileName}" 	width=400 height=258>
                                </div>                            
                                <div class="blog__item__text">
                                  ...
                                  <p>카테고리 분류11 : ${list.TKind}</p>  
                                 <div id="abc"><a href="B_view?BNo=${list.BNo}&page=${paging.page}" class="blog__btn">READ MORE <span class="arrow_right"></span></a></div>           
                        ...
                        <!-- 이전 -->
							...
							<c:if test = "${paging.page > 1}">
								<a href="B_list?page=${paging.page-1}"><i class="fa fa-long-arrow-left"></i></a> 
							</c:if>
						...
						<!-- [다음] 페이지 처리 : 현제 페이지 에서 + 1 페이지-->
							<c:if test = "${paging.page >= paging.maxPage}"><a><i class="fa fa-long-arrow-right"></i></a></c:if>
								...
								<a href="B_list?page=${paging.page + 1}"><i class="fa fa-long-arrow-right"></i></a> 
								</c:if>
                         </div>
                        </div>
