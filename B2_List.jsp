            ...
            <div class="row">
                      ...
                      <div class="sidebar__item">
                            <div class="latest-product__text">
                             ...
                             <!--    <div class="latest-prdouct__slider__item"> -->
                                <c:forEach var="list3" items="${board2List3}">
                                       <div class="latest-prdouct__slider__item">
                        ...
                        <div class="blog__sidebar__item">
                            <h4>★최신 판매 글★</h4>
                             ...
                             <c:forEach var="list2" items="${board2List2}">
                ...
                <!-- 판매글 목록  -->
                 ...
                 <div class="row">  
              			...
              			<c:forEach var="list" items="${board2List1}">
                       <div class="col-lg-6 col-md-6 col-sm-6"> 
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<c:if test = "${paging.page > 1}">
								<a href="B2_list?page=${paging.page-1}"><i class="fa fa-long-arrow-left"></i></a> 
							</c:if>
						...
						<!-- [다음] 페이지 처리 : 현제 페이지 에서 + 1 페이지-->
							<c:if test = "${paging.page >= paging.maxPage}"><a><i class="fa fa-long-arrow-right"></i></a></c:if>
								...
								<a href="B2_list?page=${paging.page + 1}"><i class="fa fa-long-arrow-right"></i></a> 
								</c:if>
                         </div>
                        </div>
