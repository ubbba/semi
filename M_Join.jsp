					...
					<div class="col-lg-8 col-md-6">
							...
							<div class="col-lg-6">
								<div class="checkout__input">
									...
									<input type="text" style="width: 200px; height: 50px;"
										name="MId" id="MId"> <input type="button"
										style="text-align: center; width: 130px; height: 50px;"
										value="중복체크 " onclick="idOverlap()"> <br /> <span
										id="confirmId"></span>
								</div>
							</div>
						</div>
						...
						<div class="checkout__input">
							...
							<input type="text" id="sample6_postcode"
								style="width: 150px; height: 50px;" placeholder="우편번호"
								name="addr1"> <input type="button"
								onclick="sample6_execDaumPostcode()"
								style="width: 170px; height: 50px;" value="우편번호 찾기"><br>
						...
						<div class="checkout__input">
							...
							<input type="email" name="MEmail" id="MEmail"> <span
