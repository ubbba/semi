            ...
            <div class="checkout__form" >
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                            ...
                            <div class="checkout__order" style="text-align:center;">
                                <ul>
								<li><strong>아이디</strong> : ${view.MId}</li>

								<li><strong>이름</strong> : ${view.MName}</li>

								<li><strong>주소</strong>  : ${view.MAddr}</li>

								<li><strong>연락처</strong>  : ${view.MPhone}</li>

								<li><strong>이메일</strong>  : ${view.MEmail}</li>

								<li><strong>생년월일</strong>  : ${view.MBirth}</li>
								</ul>
								
		<c:if test="${sessionScope.loginId eq view.MId}">
		<tr>
			<td colspan="2">
				<button style="width:400px; height:50px;" onclick="location.href='M_modiForm?MId=${view.MId}'" class="site-btn">수정</button>
				<br/>
				<button style="width:400px; height:50px;" onclick="location.href='M_delete?MId=${view.MId}'"  class="site-btn">탈퇴</button>
			</td>
		</tr>
		</c:if>
		</div>
